...
from corc.core.util import (
    validate_dict_fields,
    validate_dict_values,
    validate_either_values,
)
from corc.core.helpers import load_aws_config
from corc.core.storage.s3 import (
    bucket_exists,
    delete_bucket,
    delete_objects,
    list_objects,
...
def get_results(provider, provider_kwargs, job={}, storage={}):
    # TODO, temp fix
    s3 = storage["s3"]
