...
def job_group(parser):
    ...
    job_group.add_argument("--job-min-cores", type=str, default="")
    job_group.add_argument("--job-max-cores", type=str, default="")
    job_group.add_argument("--job-min-memory", type=str, default="")
    job_group.add_argument("--job-max-memory", type=str, default="")
