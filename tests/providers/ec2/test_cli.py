...
class TestCLIEc2(unittest.TestCase):
    def setUp(self):
    ...
    def test_cli_config_ec2_help(self):
        args = ["corc", "config", "ec2", "-h"]
        result = subprocess.run(args)
        self.assertIsNotNone(result)
        self.assertTrue(hasattr(result, "returncode"))
        self.assertEqual(result.returncode, 0)
    ...
    def test_cli_instance_ec2_help(self):
        args = ["corc", "instance", "orchestration", "ec2", "-h"]
        result = subprocess.run(args)
        self.assertIsNotNone(result)
        self.assertTrue(hasattr(result, "returncode"))
        self.assertEqual(result.returncode, 0)

    def test_cli_instance_ec2_start(self):
        args = ["corc", "instance", "orchestration", "ec2"]
    ...
    def test_cli_instance_ec2_get(self):
        args = ["corc", "instance", "orchestration", "ec2"]
    ...
    def test_clit_instance_ec2_stop(self):
        args = ["corc", "instance", "orchestration", "ec2"]
    ...
    # def test_cli_instance_ec2_delete(self):
    #     args = ["corc", "instance", "orchestration", "ec2"]
